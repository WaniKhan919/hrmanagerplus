...
var ThemeCustomizer = function() {
    ...
    return _createClass(e, [{
        ...
        value: function() {
            ...
            s && (e = document.querySelector("input[type=radio][name=data-layout][value=" + s.nav + "]"), t = document.querySelector("input[type=radio][name=data-bs-theme][value=" + s.theme + "]"), n = document.querySelector("input[type=radio][name=data-layout-mode][value=" + s.layout.mode + "]"), a = document.querySelector("input[type=radio][name=data-topbar-color][value=" + s.topbar.color + "]"), o = document.querySelector("input[type=radio][name=data-menu-color][value=" + s.menu.color + "]"), r = document.querySelector("input[type=radio][name=data-sidenav-size][value=" + s.sidenav.size + "]"), i = document.querySelector("input[type=radio][name=data-layout-position][value=" + s.layout.position + "]"), c = document.querySelector("input[type=checkbox][name=sidebar-user]"), e && (e.checked = !0), t && (t.checked = !0), n && (n.checked = !0), a && (a.checked = !0), o && (o.checked = !0), r && (r.checked = !0), i && (i.checked = !0), c && "true" === s.sidenav.user.toString() && (c.checked = !0))
        }
    }, {
        key: "init",
        value: function() {
