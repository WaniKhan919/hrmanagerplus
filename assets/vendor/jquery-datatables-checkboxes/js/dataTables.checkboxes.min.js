/*! jQuery DataTables Checkboxes v1.2.13 - www.gyrocode.com/projects/jquery-datatables-checkboxes/ - License: MIT - Author: Gyrocode LLC / www.gyrocode.com */ ! function(c) {
    ...
    x.prototype = {
        _constructor: function() {
            for (var e, t, c, s, o, l, a, n = this, d = n.s.dt, i = n.s.ctx, h = !1, r = !1, u = 0; u < i.aoColumns.length; u++) {
                i.aoColumns[u].checkboxes && (e = k(d.column(u).header()), h = !0, k.isPlainObject(i.aoColumns[u].checkboxes) || (i.aoColumns[u].checkboxes = {}), i.aoColumns[u].checkboxes = k.extend({}, x.defaults, i.aoColumns[u].checkboxes), t = {
                    searchable: !1,
                    orderable: !1
                }, "" === i.aoColumns[u].sClass ? t.className = "dt-checkboxes-cell" : t.className = i.aoColumns[u].sClass + " dt-checkboxes-cell", null === i.aoColumns[u].sWidthOrig && (t.width = "1%"), null === i.aoColumns[u].mRender && (t.render = function() {
                    return '<input type="checkbox" class="dt-checkboxes" autocomplete="off">'
                }), p.ext.internal._fnColumnOptions(i, u, t), e.removeClass("sorting"), e.off(".dt"), null === i.sAjaxSource && ((c = d.cells("tr", u)).invalidate("data"), k(c.nodes()).addClass(t.className)), n.s.data[u] = {}, n.s.dataDisabled[u] = {}, n.s.columns.push(u), i.aoColumns[u].checkboxes.selectRow && (i._select ? r = !0 : i.aoColumns[u].checkboxes.selectRow = !1), i.aoColumns[u].checkboxes.selectAll && (e.data("html", e.html()), null !== i.aoColumns[u].checkboxes.selectAllRender && (s = "", k.isFunction(i.aoColumns[u].checkboxes.selectAllRender) ? s = i.aoColumns[u].checkboxes.selectAllRender() : "string" == typeof i.aoColumns[u].checkboxes.selectAllRender && (s = i.aoColumns[u].checkboxes.selectAllRender), e.html(s).addClass("dt-checkboxes-select-all").attr("data-col", u))))
            }
            h && (n.loadState(), o = k(d.table().node()), l = k(d.table().body()), a = k(d.table().container()), r && (o.addClass("dt-checkboxes-select"), o.on("user-select.dt.dtCheckboxes", function(e, t, c, s, o) {
            ...
            }), r || a.on("click.dtCheckboxes", "tbody td.dt-checkboxes-cell", function() {
                k('input[type="checkbox"]', this).not(":disabled").trigger("click")
        ...
        onDataTablesStateSave: function(e, t, c) {
            ...
            k.each(s.s.columns, function(e, t) {
                o.aoColumns[t].checkboxes.stateSave && (Object.prototype.hasOwnProperty.call(c, "checkboxes") || (c.checkboxes = []), c.checkboxes[t] = s.s.data[t])
            })
        },
        ...
        updateStateCheckboxes: function(e) {
            ...
            t.cells("tr", o.s.columns, e).every(function(e, t) {
                ...
                Object.prototype.hasOwnProperty.call(l.checkboxes.s.data, t) && Object.prototype.hasOwnProperty.call(l.checkboxes.s.data[t], c) && (l.aoColumns[t].checkboxes.selectRow && s && o.updateSelect(e, !0), o.updateCheckbox(this, t, !0)), s || k("input.dt-checkboxes", this.node()).prop("disabled", !0)
            })
        },
        onClick: function(e, c) {
            var s = this,
                ...
                i = d.column;
            d.row;
            o.aoColumns[i].checkboxes.selectRow ? o._select && ("os" === o._select.style ? (e.stopPropagation(), n.checkboxes.select(c.checked)) : setTimeout(function() {
                var e = n.data(),
                    t = Object.prototype.hasOwnProperty.call(s.s.data, i) && Object.prototype.hasOwnProperty.call(s.s.data[i], e);
                t !== c.checked && (s.updateCheckbox(n, i, t), s.updateSelectAll(i))
        ...
        updateSelectAll: function(c) {
            var e, t, s, o, l, a, n, d, i, h, r, u = this,
                b = u.s.dt,
                x = u.s.ctx;
            x.aoColumns[c].checkboxes && x.aoColumns[c].checkboxes.selectAll && (e = b.cells("tr", c, {
                ...
                u.isCellSelectable(c, t) ? Object.prototype.hasOwnProperty.call(u.s.data, c) && Object.prototype.hasOwnProperty.call(u.s.data[c], t) && o++ : l++
            }), x._fixedHeader && x._fixedHeader.dom.header.floating && (s = k('.fixedHeader-floating .dt-checkboxes-select-all[data-col="' + c + '"] input[type="checkbox"]')), d = 0 === o ? n = !1 : o + l === a.length ? !(n = !0) : n = !0, i = s.data("is-changed"), h = s.prop("checked"), r = s.prop("indeterminate"), !i && h === n && r === d || (s.data("is-changed", !1), s.prop({
                checked: !d && n,
                indeterminate: d
        ...
        showInfoSelected: function() {
            ...
            if (e.aanFeatures.i) {
                ...
                if (null !== t) {
                    var d = 0;
                    for (var c in e.checkboxes.s.data[t]) Object.prototype.hasOwnProperty.call(e.checkboxes.s.data, t) && Object.prototype.hasOwnProperty.call(e.checkboxes.s.data[t], c) && d++;
    ...
    return t.register("checkboxes()", function() {
        ...
        return void 0 === i && (i = !0), this.iterator("column-rows", function(c, s, e, t, o) {
            ...
            }), l = this.cells(d), c.checkboxes.updateData(l, s, i), c.aoColumns[s].checkboxes.selectRow && c.checkboxes.updateSelect(n, i), c.checkboxes.updateCheckbox(l, s, i), c.checkboxes.updateSelectAll(s), c.checkboxes.updateFixedColumn(s))
        }, 1)
        ...
        return void 0 === l && (l = !0), this.iterator("cell", function(e, t, c) {
            ...
            e.aoColumns[c].checkboxes && (s = this.cells([{
                ...
                row: t,
                column: c
            }).data(), e.checkboxes.isCellSelectable(c, o) && (e.checkboxes.updateData(s, c, l), e.aoColumns[c].checkboxes.selectRow && e.checkboxes.updateSelect(t, l), e.checkboxes.updateCheckbox(s, c, l), e.checkboxes.updateSelectAll(c), e.checkboxes.updateFixedColumn(c)))
        }, 1)
        ...
        return void 0 === a && (a = !0), this.iterator("cell", function(e, t, c) {
            ...
            e.aoColumns[c].checkboxes && (o = (s = this.cell({
                row: t,
                column: c
            })).data(), a ? delete e.checkboxes.s.dataDisabled[c][o] : e.checkboxes.s.dataDisabled[c][o] = 1, (l = s.node()) && k("input.dt-checkboxes", l).prop("disabled", !a), e.aoColumns[c].checkboxes.selectRow && Object.prototype.hasOwnProperty.call(e.checkboxes.s.data, c) && Object.prototype.hasOwnProperty.call(e.checkboxes.s.data[c], o) && e.checkboxes.updateSelect(t, a))
        }, 1)
        ...
        return this.iterator("column-rows", function(c, s, e, t, o) {
            if (c.aoColumns[s].checkboxes) {
                ...
                return c.oFeatures.bServerSide ? k.each(c.checkboxes.s.data[s], function(e) {
                    ...
                    Object.prototype.hasOwnProperty.call(c.checkboxes.s.data, s) && Object.prototype.hasOwnProperty.call(c.checkboxes.s.data[s], t) && c.checkboxes.isCellSelectable(s, t) && n.push(t)
                })), n
            }
            return []
        }, 1)
    }), x.version = "1.2.13", k.fn.DataTable.Checkboxes = x, k.fn.dataTable.Checkboxes = x, k(b).on("preInit.dt.dtCheckboxes", function(e, t) {
